...
import com.gridee.parking.databinding.DialogTopupBinding
import com.gridee.parking.databinding.FragmentWalletBinding
...
class WalletFragment : BaseTabFragment<FragmentWalletBinding>() {

    private lateinit var transactionsAdapter: TransactionsAdapter
    private var currentBalance = 0.0
    private var userTransactions = mutableListOf<Transaction>()

    override fun getViewBinding(inflater: LayoutInflater, container: ViewGroup?): FragmentWalletBinding {
    ...
    private fun showTopUpDialog() {
        ...
        // Set current balance in dialog
        dialogBinding.tvCurrentBalance.text = "$${String.format("%.2f", currentBalance)}"

        // Payment method selection
        dialogBinding.tvSelectPayment.setOnClickListener {
            // TODO: Show payment method selection dialog
            // This would integrate with your payment gateway (Stripe, PayPal, etc.)
            showToast("Payment method selection coming soon!")
        }

        // Quick amount buttons
        dialogBinding.btnAmount10.setOnClickListener {
            dialogBinding.etAmount.setText("10.00")
        }
        dialogBinding.btnAmount25.setOnClickListener {
            dialogBinding.etAmount.setText("25.00")
        }
        dialogBinding.btnAmount50.setOnClickListener {
            dialogBinding.etAmount.setText("50.00")
        }
        ...
        dialogBinding.btnTopup.setOnClickListener {
