...
object ApiConfig {
    ...
    const val BASE_URL = "http://10.3.179.67:8080/"  // Updated to current Mac IP on port 8080
    ...
    // const val BASE_URL = "https://10.3.179.67:8443/"  // HTTPS version (if SSL is configured)
