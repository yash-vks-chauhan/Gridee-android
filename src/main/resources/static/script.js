...
//<!--            document.getElementById("bookingVehicleNumber").innerHTML =-->
...
//<!--            tr.innerHTML = `<td>${user.id || ""}</td><td>${user.name || ""}</td><td>${user.email || ""}</td><td>${user.phone || ""}</td><td>${Array.isArray(user.vehicleNumbers) ? user.vehicleNumbers.join(", ") : user.vehicleNumber || ""-->
//<!--                }</td><td>${user.walletCoins || 0}</td>`;-->
...
//<!--            .getElementById("userVehicleNumbers")-->
//<!--            .value.split(",")-->
//<!--            .map((v) => v.trim())-->
//<!--            .filter(Boolean);-->
...
//<!--            alert(-->
//<!--                "Fill all required fields (name, email, phone, password, at least one vehicle number)."-->
//<!--            );-->
//<!--            return;-->
//<!--        }-->
//<!--        try {-->
...
//<!--                document.getElementById("usersResponse").textContent = `User registered: ${JSON.stringify(-->
//<!--                    user-->
//<!--                )}`;-->
//<!--                fetchUsers();-->
//<!--            } else {-->
...
//<!--        const vehicleNumbers = document-->
//<!--            .getElementById("updateUserVehicleNumbers")-->
//<!--            .value.split(",")-->
//<!--            .map((v) => v.trim())-->
//<!--            .filter(Boolean);-->
...
//<!--                document.getElementById("usersResponse").textContent = `User updated: ${JSON.stringify(-->
//<!--                    updatedUser-->
//<!--                )}`;-->
//<!--                fetchUsers();-->
//<!--            } else {-->
...
//<!--    // BOOKINGS-->
//
//<!--    function bookingsUserIdInput() {-->
//<!--        return document.getElementById("bookingUserId").value.trim();-->
//<!--    }-->
//
//<!--    async function fetchBookings() {-->
//<!--        const userId = bookingsUserIdInput();-->
//<!--        if (!userId) {-->
//<!--            alert("Enter User ID to fetch bookings");-->
//<!--            return;-->
//<!--        }-->
//<!--        const res = await fetch(`${baseUrl}/users/${encodeURIComponent(userId)}/bookings`);-->
//<!--        if (!res.ok) {-->
//<!--            alert("Failed to fetch bookings for user");-->
//<!--            return;-->
//<!--        }-->
//<!--        const data = await res.json();-->
...
//<!--        const userId = bookingsUserIdInput();-->
//<!--        if (!userId) {-->
//<!--            alert("Enter User ID to load vehicles");-->
//<!--            return;-->
//<!--        }-->
//<!--        const res = await fetch(`${baseUrl}/users/${encodeURIComponent(userId)}`);-->
//<!--        if (!res.ok) {-->
//<!--            alert("Failed to load user vehicles");-->
//<!--            return;-->
//<!--        }-->
//<!--        const user = await res.json();-->
...
//
//<!--        try {-->
//<!--            const url = `${baseUrl}/users/${encodeURIComponent(userId)}/bookings/start?spotId=${encodeURIComponent(-->
//<!--                spotId-->
//<!--            )}&lotId=${encodeURIComponent(lotId)}&checkInTime=${encodeURIComponent(checkInTime)}&checkOutTime=${encodeURIComponent(-->
//<!--                checkOutTime-->
...
//<!--        if (!userId || !id) {-->
//<!--            alert("Enter User ID and Booking ID");-->
//<!--            return;-->
//<!--        }-->
...
//<!--        }-->
//<!--        try {-->
//<!--            const res = await fetch(`${baseUrl}/parking-spots/${encodeURIComponent(id)}/hold?userId=${encodeURIComponent(userId)}`, {-->
//<!--                method: "POST",-->
//<!--            });-->
//<!--            if (res.ok) {-->
...
//<!--        try {-->
//<!--            const res = await fetch(`${baseUrl}/parking-spots/${encodeURIComponent(id)}/release`, {-->
//<!--                method: "POST",-->
//<!--            });-->
//<!--            if (res.ok) {-->
...
//<!--        try {-->
//<!--            const res = await fetch(`${baseUrl}/parking-spots/${encodeURIComponent(id)}`, {-->
//<!--                method: "DELETE",-->
//<!--            });-->
//<!--            if (res.ok) {-->
//<!--                alert("Spot deleted");-->
...
//<!--        try {-->
//<!--            const res = await fetch(`${baseUrl}/parking-lots/${encodeURIComponent(id)}`, {-->
//<!--                method: "DELETE",-->
//<!--            });-->
//<!--            if (res.ok) {-->
//<!--                alert("Lot deleted");-->
